...
public class EdgeFXBackup {
    ...
    private List<EdgeFXBackup> edgeList = new ArrayList<>();
    
    private Group group;
    
    public EdgeFXBackup(NodeFX start, NodeFX end, String name) {
    ...
    public void setEdgeList(List<EdgeFXBackup> edgeList) {
